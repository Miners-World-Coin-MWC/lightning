...
const struct chainparams networks[] = {
    ...
    {.network_name = "litecoin-testnet",
     ...
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_TEST_PUBLIC,
			   .bip32_privkey_version = BIP32_VER_TEST_PRIVATE},
     .is_elements = false},
    {.network_name = "minersworldcoin",
     .bip173_name = "mwc",
     .bip70_name = "main",
     .genesis_blockhash = {{{.u.u8 = {
         0x9f, 0xe9, 0xde, 0xff, 0x66, 0x10, 0x5f, 0x56,
         0xa5, 0x0c, 0xe4, 0x60, 0x0f, 0xa3, 0x33, 0x85,
         0x27, 0x5f, 0x01, 0x0a, 0xe9, 0x19, 0xaa, 0x35,
         0x74, 0xac, 0x8c, 0x95, 0x45, 0xbf, 0x4c, 0x88
     }}}},
     .rpc_port = 4408,
     .cli = "minersworldcoin-cli",
     .cli_args = NULL,
     .cli_min_supported_version = 160000,
     .dust_limit = {546},
     .max_funding = AMOUNT_SAT_INIT((1 << 24) - 1),
     .max_payment = AMOUNT_MSAT_INIT(0xFFFFFFFFULL),
     .when_lightning_became_cool = 1,
