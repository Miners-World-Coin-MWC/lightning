...
struct db_query db_sqlite3_queries[] = {
    ...
    {
         .name = "SELECT id, dust_limit_satoshis, max_htlc_value_in_flight_msat, channel_reserve_satoshis, htlc_minimum_msat, to_self_delay, max_accepted_htlcs, max_dust_htlc_exposure_msat FROM channel_configs WHERE id= ? ;",
         .query = "SELECT id, dust_limit_satoshis, max_htlc_value_in_flight_msat, channel_reserve_satoshis, htlc_minimum_msat, to_self_delay, max_accepted_htlcs, max_dust_htlc_exposure_msat FROM channel_configs WHERE id= ? ;",
         .placeholders = 1,
         .readonly = true,
    },
    {
    ...
    {
         .name = "INSERT INTO channel_htlcs ( channel_id, channel_htlc_id, direction, origin_htlc, msatoshi, cltv_expiry, payment_hash, payment_key, hstate, routing_onion, malformed_onion, partid, groupid, min_commit_num) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?, ?);",
         .query = "INSERT INTO channel_htlcs ( channel_id, channel_htlc_id, direction, origin_htlc, msatoshi, cltv_expiry, payment_hash, payment_key, hstate, routing_onion, malformed_onion, partid, groupid, min_commit_num) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?, ?);",
         .placeholders = 13,
         .readonly = false,
    },
    {
    ...
    {
         .name = "SELECT  id, channel_htlc_id, msatoshi, cltv_expiry, hstate, payment_hash, payment_key, routing_onion, failuremsg, malformed_onion, origin_htlc, shared_secret, received_time, we_filled, fail_immediate FROM channel_htlcs WHERE direction= ? AND channel_id= ? AND hstate != ?",
         .query = "SELECT  id, channel_htlc_id, msatoshi, cltv_expiry, hstate, payment_hash, payment_key, routing_onion, failuremsg, malformed_onion, origin_htlc, shared_secret, received_time, we_filled, fail_immediate FROM channel_htlcs WHERE direction= ? AND channel_id= ? AND hstate != ?",
         .placeholders = 3,
         .readonly = true,
    },
    {
         ...
         .query = "SELECT  id, channel_htlc_id, msatoshi, cltv_expiry, hstate, payment_hash, payment_key, routing_onion, failuremsg, malformed_onion, origin_htlc, shared_secret, received_time, partid, localfailmsg, groupid FROM channel_htlcs WHERE direction = ? AND channel_id = ? AND hstate != ?",
         .placeholders = 3,
         .readonly = true,
    },
    {
    ...
    },
    {
         ...
         .query = "SELECT status FROM payments WHERE payment_hash=? AND partid = ? AND groupid = ?;",
         .placeholders = 3,
         .readonly = true,
    },
    {
         .name = "INSERT INTO payments (  status,  payment_hash,  destination,  msatoshi,  timestamp,  path_secrets,  route_nodes,  route_channels,  msatoshi_sent,  description,  bolt11,  total_msat,  partid,  local_offer_id,  groupid) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",
         .query = "INSERT INTO payments (  status,  payment_hash,  destination,  msatoshi,  timestamp,  path_secrets,  route_nodes,  route_channels,  msatoshi_sent,  description,  bolt11,  total_msat,  partid,  local_offer_id,  groupid) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",
         .placeholders = 15,
         .readonly = false,
    },
    {
    ...
    },
    {
         ...
         .query = "SELECT  id, status, destination, msatoshi, payment_hash, timestamp, payment_preimage, path_secrets, route_nodes, route_channels, msatoshi_sent, description, bolt11, failonionreply, total_msat, partid, local_offer_id, groupid FROM payments WHERE payment_hash = ? AND partid = ? AND groupid=?",
         .placeholders = 3,
         .readonly = true,
    },
    {
         .name = "UPDATE payments SET status=? WHERE payment_hash=? AND partid=? AND groupid=?",
         .query = "UPDATE payments SET status=? WHERE payment_hash=? AND partid=? AND groupid=?",
         .placeholders = 4,
         .readonly = false,
    },
    {
    ...
    },
    {
         ...
         .query = "SELECT failonionreply, faildestperm, failindex, failcode, failnode, failchannel, failupdate, faildetail, faildirection  FROM payments WHERE payment_hash=? AND partid=? AND groupid=?;",
         .placeholders = 3,
         .readonly = true,
    },
    {
    ...
    {
         .name = "SELECT  id, status, destination, msatoshi, payment_hash, timestamp, payment_preimage, path_secrets, route_nodes, route_channels, msatoshi_sent, description, bolt11, failonionreply, total_msat, partid, local_offer_id, groupid FROM payments WHERE  (payment_hash = ? OR 1=?) AND  (status = ? OR 1=?) ORDER BY id;",
         .query = "SELECT  id, status, destination, msatoshi, payment_hash, timestamp, payment_preimage, path_secrets, route_nodes, route_channels, msatoshi_sent, description, bolt11, failonionreply, total_msat, partid, local_offer_id, groupid FROM payments WHERE  (payment_hash = ? OR 1=?) AND  (status = ? OR 1=?) ORDER BY id;",
         .placeholders = 4,
         .readonly = true,
    },
    {
         .name = "SELECT  id, status, destination, msatoshi, payment_hash, timestamp, payment_preimage, path_secrets, route_nodes, route_channels, msatoshi_sent, description, bolt11, failonionreply, total_msat, partid, local_offer_id, groupid FROM payments WHERE local_offer_id = ?;",
         .query = "SELECT  id, status, destination, msatoshi, payment_hash, timestamp, payment_preimage, path_secrets, route_nodes, route_channels, msatoshi_sent, description, bolt11, failonionreply, total_msat, partid, local_offer_id, groupid FROM payments WHERE local_offer_id = ?;",
         .placeholders = 1,
         .readonly = true,
    },
    {
...
#define DB_SQLITE3_QUERY_COUNT 354

#endif /* HAVE_SQLITE3 */

#endif /* LIGHTNINGD_WALLET_GEN_DB_SQLITE3 */

// SHA256STAMP:c53d86c28a1b0924673362012ac581510ba34e2402fb769d999f98312c5382b8
