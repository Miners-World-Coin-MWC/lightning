...
/* WIRE: CONNECTD_INIT */
u8 *towire_connectd_init(const tal_t *ctx, const struct chainparams *chainparams, const struct feature_set *our_features, const struct node_id *id, const struct wireaddr_internal *wireaddrs, const enum addr_listen_announce *listen_announce, const struct wireaddr *tor_proxyaddr, bool use_tor_proxy_always, bool dev_allow_localhost, bool use_dns, const wirestring *tor_password, bool use_v3_autotor, u32 timeout_secs, const wirestring *websocket_helper, u16 websocket_port)
{
	...
	towire_wirestring(&p, websocket_helper);
	towire_u16(&p, websocket_port);

	return memcheck(p, tal_count(p));
}
bool fromwire_connectd_init(const tal_t *ctx, const void *p, const struct chainparams **chainparams, struct feature_set **our_features, struct node_id *id, struct wireaddr_internal **wireaddrs, enum addr_listen_announce **listen_announce, struct wireaddr **tor_proxyaddr, bool *use_tor_proxy_always, bool *dev_allow_localhost, bool *use_dns, wirestring **tor_password, bool *use_v3_autotor, u32 *timeout_secs, wirestring **websocket_helper, u16 *websocket_port)
{
	u16 num_wireaddrs;
	...
	*listen_announce = num_wireaddrs ? tal_arr(ctx, enum addr_listen_announce, num_wireaddrs) : NULL;
 	...
 	*websocket_helper = fromwire_wirestring(ctx, &cursor, &plen);
 	*websocket_port = fromwire_u16(&cursor, &plen);
	return cursor != NULL;
}
...
// SHA256STAMP:8b6e031e6fa3f803d33f61d13001aff783dad666bc74a5b231b2830e87efc2da
